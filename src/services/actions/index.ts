...
import { getIngredientsConstructor, addIngredientConstructor, removeIngredientConstructor, updateIngredientConstructor, removeIngredientsConstructor } from './ingredients-constructor'
...
export const actions = { getIngredientsAction, getIngredientsConstructor, addIngredientConstructor, removeIngredientConstructor, addIngredientDetails, 
    removeIngredientDetails, sendOrderAction, updateCountIngredients, updateIngredientConstructor, removeIngredientsConstructor, removeOrderDetails, login, register, getUser, updateUser, 
