...
export const REMOVE_INGREDIENTS_CONSTRUCTOR = "REMOVE_INGREDIENTS_CONSTRUCTOR";
...
export const UPDATE_USER_SUCCESS = 'UDATE_USER_SUCCESS'; 
...
export const CONFIRM_RESET_PASSWORD_SUCCESS = 'COMFIRM_RESET_PASSWORD_SUCCESS';
