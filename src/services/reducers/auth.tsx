import { setCookie, getCookie, deleteCookie } from "../../components/utils/cookie-utils";
import { LOGIN_REQUEST, LOGIN_SUCCESS, LOGIN_FAILED, REGISTER_REQUEST, REGISTER_SUCCESS, REGISTER_FAILED, LOGOUT_REQUEST, LOGOUT_SUCCESS, LOGOUT_FAILED,
...
export const authReducer = (state = initialState, action: any) => {
    switch (action.type) {
        ...
        case LOGIN_SUCCESS: {
            ...
            return { ...state, user: action.payload.user, refreshToken: action.payload.refreshToken, 
